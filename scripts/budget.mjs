...
const BUDGET = {
  'מובייל 390': {
    // ‏4.8 (D17): מנוע-הרצועה המשותף + CSS הגלריה - נמדד 172KB + ~3%
    critical: 178 * 1024,
    // ‏29.7 (T14): הרצף הוחלף למקור ה-4K שבחר OC — ‏m ‏1.3→2.26MB (webp).
    // עדכון מכוון: נמדד 2172KB אחרי ההחלפה + ~12%. הקריטי לא זז.
    total: 2.4 * 1024 * 1024,
    // ‏3.8 (🌅 ההגעה החיה, אישור OC): מנוע-הרשת + שכבות ה-CSS הוסיפו
    // ‏~5KB. עדכון מכוון: ‏JS נמדד 204KB + ~3% · ‏CSS נמדד 101KB + ~4%.
    js: 210 * 1024,
    css: 105 * 1024,          // כולל ה-CSS וקובצי הגופן של Google
  ...
  'דסקטופ 1440': {
    ...
    total: 4.4 * 1024 * 1024,
    // ‏3.8 (🌅): אותו עדכון מכוון כמו במובייל
    js: 210 * 1024,
    css: 105 * 1024,
    images: 120 * 1024,
  },
